...
```{r plot1, echo=FALSE, fig.height=6, fig.width=8, out.width=500}
```
...
ggsave("libs/images/w5/aside.png", width = 7, height = 5)
```
...
.midi[This gives us a general idea of what is going on...but doesn't account for variability at all! Maybe these differences don't actually mean anything in the context of the variability of our data. That is why we want to take a modelling approach.]
