...
* We interpret __coefficients__ as __risk ratios__
  * Similar to logistic regression, we are interpreting the coefficients on the multiplicative scale after transforming with the inverse of our link function.
* __Offsets__
...
* __Overdispersion__
  * A key assumption of Poisson regression is that the mean and variance of our response are equal. If the variance is greater than the mean we have overdispersion. 
